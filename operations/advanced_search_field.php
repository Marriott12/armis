...
<div class="main-content">
    <h2 class="mt-4 mb-4">Advanced Field Operations Search</h2>
    <form id="field-search-form" class="row g-3 mb-4">
        <div class="col-md-4">
            <label for="search" class="form-label">Operation Name</label>
            <input type="text" name="search" id="search" class="form-control" placeholder="Enter operation name">
        </div>
        <div class="col-md-3">
...
document.getElementById('search-btn').onclick = function() {
    ...
    fetch('ajax_search_field.php?' + params)
