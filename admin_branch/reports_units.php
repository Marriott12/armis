...
$pageTitle = "Units Report as at " . date('d-M-Y');
$currentPage = "reports";
...
$params = [];
$sql = "SELECT s.*, r.name as rankName, r.level as rankLevel, u.name as unitName FROM staff s
...
$sql .= " ORDER BY r.level ASC, u.name ASC, s.last_name ASC, s.first_name ASC";
