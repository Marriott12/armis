...
if ($search !== '') {
    $sql .= " AND (s.marital LIKE ? OR s.svcNo LIKE ? OR s.lName LIKE ? OR s.fName LIKE ? OR r.rankId LIKE ? OR u.name LIKE ? OR s.category LIKE ?)";
    ...
    <div class="container-fluid">
        <div class="main-content">
            ...
            <div class="mb-2">
                ...
                <?php $columns = [
                    'marital_status'=>'Marital Status','unit'=>'Unit','rank'=>'Rank','svcNo'=>'Service No','surname'=>'Surname','fName'=>'First Name(s)',
