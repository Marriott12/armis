...
$pageTitle = "CE Seniority Roll as at " . date('d-M-Y');
$moduleName = "Admin Branch";
$moduleIcon = "users-cog";
$currentPage = "ce_seniority";
...
document.getElementById('exportExcelBtn').addEventListener('click', function() {
    let table = document.getElementById('seniorityTable');
    let wb = XLSX.utils.table_to_book(table, {sheet:"CE Seniority"});
    XLSX.writeFile(wb, 'ce_seniority_report.xlsx');
});
...
document.getElementById('exportPDFBtn').addEventListener('click', function(){
    ...
    let doc = new jsPDF();
    let startY = 20;
    doc.text("CE Seniority Report", 14, startY);
