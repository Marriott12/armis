...
// Order by unit, then rankIndex, then surname, then first name
$sql .= " ORDER BY u.unitName ASC, r.rankIndex ASC, s.lname ASC, s.fname ASC";
...
<div class="container my-5">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0"><i class="fa fa-building"></i> Unit List</h4>
        </div>
        <div class="card-body">
