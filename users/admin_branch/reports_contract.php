...
<div class="container my-5">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-warning text-dark d-flex align-items-center justify-content-between">
            <h4 class="mb-0"><i class="fa fa-file-contract"></i> Contract Staff</h4>
            <span class="badge bg-light text-warning fs-6"><?= count($staff) ?> Contract Staff Listed</span>
        </div>
        <div class="card-body">
            <form class="row g-3 mb-4" method="get" action="">
                <div class="col-md-3">
                    <input type="text" id="contractSearch" name="search" class="form-control" placeholder="Type to filter..." value="<?=htmlspecialchars($search)?>">
                </div>
                <div class="col-md-2">
                ...
                <table class="table table-bordered table-hover align-middle" id="contractTable">
                    ...
                    <tbody>
                        <?php if (count($staff) == 0): ?>
                            <tr><td colspan="12" class="text-center text-muted">No contract staff found.</td></tr>
