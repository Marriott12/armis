...
<div class="container my-5">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-dark text-white d-flex align-items-center justify-content-between">
            <h4 class="mb-0"><i class="fa fa-user-slash"></i> Deceased Staff</h4>
            <span class="badge bg-light text-dark fs-6"><?= count($staff) ?> Deceased Staff Listed</span>
        </div>
        <div class="card-body">
            <form class="row g-3 mb-4" method="get" action="">
                <div class="col-md-3">
                    <input type="text" id="deceasedSearch" name="search" class="form-control" placeholder="Type to filter..." value="<?=htmlspecialchars($search)?>">
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2 d-grid">
                    <button type="submit" class="btn btn-dark text-white"><i class="fa fa-search"></i> Filter</button>
                </div>
            </form>
                ...
                <table class="table table-bordered table-hover align-middle" id="deceasedTable">
                    ...
                    <tbody>
                        <?php if (count($staff) == 0): ?>
                            <tr><td colspan="12" class="text-center text-muted">No deceased staff found.</td></tr>
...
document.getElementById('deceasedSearch').addEventListener('keyup', function() {
