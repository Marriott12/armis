<?php
    ...
    if (Input::exists()) 
    {
        ...
        $svcNo = Input::get('svcNo');
        $unit = Input::get('unit');
        $category = Input::get('category');
        $gender = Input::get('gender');
        $rank = Input::get('rank');
        $combat = Input::get('combat');
        $boot = Input::get('boot');
        $nrc = Input::get('nrc');
        ...
        $validation = new Validate();
            ...
            $valArray = [
                ...
                'svcNo' => [
                    'display' => lang('GEN_UNUMBER'),
                    'required' => true,
                    'min' => 1,
                    'max' => 10,
                ],
                'unit' => [
                    'display' => lang('GEN_UNIT'),
                    'required' => true,
                    'min' => 1,
                    'max' => 10,
                ],
                'category' => [
                    'display' => lang('GEN_CAT'),
                    'required' => true,
                    'min' => 1,
                    'max' => 10,
                ],
                'gender' => [
                    'display' => lang('GEN_GENDER'),
                    'required' => true,
                    'min' => 1,
                    'max' => 10,
                ],
                'rank' => [
                    'display' => lang('GEN_RANK'),
                    'required' => true,
                    'min' => 1,
                    'max' => 10,
                ],
                'blood' => [
                    'display' => lang('GEN_BLOOD'),
                    'required' => true,
                    'min' => 1,
                    'max' => 10,
                ],
                'combat' => [
                    'display' => lang('GEN_COMBAT'),
                    'required' => true,
                    'min' => 1,
                    'max' => 10,
                ],
                'boot' => [
                    'display' => lang('GEN_BOOT'),
                    'required' => true,
                    'min' => 1,
                    'max' => 10,
                ],
                'nrc' => [
                    'display' => lang('GEN_NRC'),
                    'required' => true,
                    'min' => 1,
                    'max' => 12,
                ],
        ...
        if ($validation->passed()) 
        {
            ...
            try 
            {
                ...
                $fields = [
                    'username' => $username,
                    'svcNo' => ucfirst(Input::get('svcNo')),
                    'category' => ucfirst(Input::get('category')),
                    'gender' => ucfirst(Input::get('gender')),
                    'rank' => ucfirst(Input::get('rank')),
                    'combat' => ucfirst(Input::get('combat')),
                    'boot' => ucfirst(Input::get('boot')),
                    'nrc' => ucfirst(Input::get('nrc')),
