...
$lang = array_merge($lang, array(
	...
	"GEN_EMAIL"				=> "Email",
	"GEN_SNUMBER"			=> "Service Number",
	"GEN_UNIT"				=> "Unit",
	"GEN_MUNIT"				=> "Main Unit",
	"GEN_RANK"				=> "Rank",
	"GEN_BLOOD"				=> "Blood Group",
	"GEN_COMBAT"			=> "Combat Size",
	"GEN_BOOT"				=> "Boot Size",
	"GEN_NRC"				=> "NRC Number",
	"GEN_CAT"				=> "Category",
	"GEN_GENDER"			=> "Gender",
	"GEN_INTAKE"			=> "Intake",
	"GEN_DOE"				=> "Date of Enlistment",
	"GEN_DOR"				=> "Date of Retirement",
	"GEN_DOB"				=> "Date of Birth",
	"GEN_PROV"				=> "Province",
	"GEN_PHONE"				=> "Phone Number",
	"GEN_MALE"				=> "Male",
	"GEN_FEMALE"			=> "Female",
	"GEN_CIVILIAN"			=> "Civilian Employee",
	"GEN_OFFICER"			=> "Officer",
	"GEN_CURRENT"			=> "Current",
	"GEN_NCO"				=> "Non-Commissioned Officer",
 	"GEN_MARITAL"			=> "Marital Status",
