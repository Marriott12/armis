...
$sidebarLinks = [
    ...
    ['title' => 'My Profile', 'url' => '/Armis2/users/profile.php', 'icon' => 'user', 'page' => 'profile'],
                ...
                <div class="info-section">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text">
                                                                ...
                                                                <strong>Date of Birth:</strong> <?php echo isset($member->dob) && $member->dob ? date('d M Y', strtotime($member->dob)) : 'Not specified'; ?>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div id="verticalTabsView" style="display: none;">
                        <div class="vertical-tabs">
                            <ul class="nav nav-tabs" id="verticalAnalyticsTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="vertical-personal-tab" data-bs-toggle="tab" data-bs-target="#vertical-personal" type="button">
                                        <i class="fas fa-user me-2"></i>Personal Details
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="vertical-contact-tab" data-bs-toggle="tab" data-bs-target="#vertical-contact" type="button">
                                        <i class="fas fa-address-book me-2"></i>Contact Info
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="vertical-sizing-tab" data-bs-toggle="tab" data-bs-target="#vertical-sizing" type="button">
                                        <i class="fas fa-ruler me-2"></i>Military Sizing
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="vertical-family-tab" data-bs-toggle="tab" data-bs-target="#vertical-family" type="button">
                                        <i class="fas fa-users me-2"></i>Family Members
                                    </button>
                                </li>
                            </ul>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body p-3">
                                                                ...
                                                                <p class="card-text small">
                                                                    ...
                                                                    <strong>DOB:</strong> <?php echo isset($member->dob) && $member->dob ? date('d M Y', strtotime($member->dob)) : 'Not specified'; ?>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="btn-group" role="group" aria-label="Chart View Toggle">
                            <button type="button" class="btn btn-sm btn-outline-primary active" id="horizontalViewBtn">
                                <i class="fas fa-columns me-1"></i> Horizontal
                            </button>
                            <button type="button" class="btn btn-sm btn-outline-primary" id="verticalViewBtn">
                                <i class="fas fa-bars me-1"></i> Vertical
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h6 class="card-title">Profile Sections Status:</h6>
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                Basic Information
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <div class="card h-100 <?php echo 'border-success'; ?>">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card h-100 <?php echo 'border-success'; ?>">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <h6>Military Sizing</h6>
                                                        <span class="badge bg-success">Complete</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <div class="card h-100 <?php echo !empty($contactInfo) ? 'border-success' : 'border-warning'; ?>">
                                                    <div class="card-body text-center">
                                                        <i class="fas fa-address-book fa-3x <?php echo !empty($contactInfo) ? 'text-success' : 'text-warning'; ?> mb-3"></i>
                                                        <h6>Contact Information</h6>
                                                        <span class="badge <?php echo !empty($contactInfo) ? 'bg-success' : 'bg-warning text-dark'; ?>">
                                                            <?php echo !empty($contactInfo) ? 'Complete' : 'Incomplete'; ?>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="card h-100 <?php echo !empty($addresses) ? 'border-success' : 'border-warning'; ?>">
                                                    <div class="card-body text-center">
                                                        <i class="fas fa-home fa-3x <?php echo !empty($addresses) ? 'text-success' : 'text-warning'; ?> mb-3"></i>
                                                        <h6>Address Information</h6>
                                                        <span class="badge <?php echo !empty($addresses) ? 'bg-success' : 'bg-warning text-dark'; ?>">
                                                            <?php echo !empty($addresses) ? 'Complete' : 'Incomplete'; ?>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="card h-100 <?php echo !empty($familyMembers) ? 'border-success' : 'border-info'; ?>">
                                                    <div class="card-body text-center">
                                                        <i class="fas fa-users fa-3x <?php echo !empty($familyMembers) ? 'text-success' : 'text-info'; ?> mb-3"></i>
                                                        <h6>Family Information</h6>
                                                        <span class="badge <?php echo !empty($familyMembers) ? 'bg-success' : 'bg-info'; ?>">
                                                            <?php echo !empty($familyMembers) ? 'Complete' : 'Optional'; ?>
                                                        </span>
                                                    </div>
                                                </div>
