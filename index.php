...
?>
		<div class="jumbotron">
			...
			<p align="center" class="text-muted">Welcome to the Army Resource Management Information System <!--<?=lang("MAINT_OPEN")?>--></p>
			<p align="center">
				<?php
				if($user->isLoggedIn()){?>
			...
			<br>
			<!--<p align="center">Make sure you have your correct login details to use this system. <?=lang("MAINT_PLEASE");?></p>
